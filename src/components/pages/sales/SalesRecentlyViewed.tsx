...
interface SalesRecentlyViewedProps {
  ...
  totalPages: number;
  currentProducts: RecentlyViewedProduct[];
  allProducts: RecentlyViewedProduct[];
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-3 flex flex-col flex-1">
                      ...
                      <p className="font-bold text-gray-800 text-sm">{typeof product.price === 'number' ? `₱${product.price.toLocaleString()}` : product.price}</p>
              ...
              {currentProducts.map((product) => (
                <div key={product.id} className="bg-white overflow-hidden relative flex flex-col h-[420px] rounded-lg">
                  ...
                  <div className="p-3 sm:p-4 flex flex-col flex-grow">
                    ...
                    <p className="font-bold text-gray-800 mt-auto text-sm sm:text-base">{typeof product.price === 'number' ? `₱${product.price.toLocaleString()}` : product.price}</p>
...
export default SalesRecentlyViewed;
